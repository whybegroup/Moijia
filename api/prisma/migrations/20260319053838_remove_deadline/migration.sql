...
INSERT INTO "new_events" ("allowMaybe", "createdAt", "createdBy", "description", "enableWaitlist", "end", "groupId", "id", "isAllDay", "location", "maxAttendees", "minAttendees", "start", "subtitle", "title", "updatedAt", "updatedBy") SELECT "allowMaybe", "createdAt", "createdBy", "description", "enableWaitlist", "end", "groupId", "id", "isAllDay", "location", "maxAttendees", "minAttendees", "start", "subtitle", "title", "updatedAt", "updatedBy" FROM "events";
DROP TABLE "events";
